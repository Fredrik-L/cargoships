...
public class StartMenu {
	...
	static int getPortObjListIndex(String portName, List<Port> portList) {
		int i = 0;
		int portIndex = 0;
		for(Port p: portList) {
	...
	static int getShipObjListIndex(int chosenId, List<Cargoships>cargoshipsList) {
	...
	public static void main(String[] args) {
        ...
        switch (choice){
            ...
            case 4:
            	...
            	int portStartIndex = getPortObjListIndex(startPort, portList);
            	int cargoShipIndex = getShipObjListIndex(chosenId, cargoshipsList);
            	...
            	int portDestinationIndex = getPortObjListIndex(destinationPort, portList);
